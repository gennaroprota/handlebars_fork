...
#ifndef BOOST_HANDLEBARS_SUPPORT_ERROR_HPP
#define BOOST_HANDLEBARS_SUPPORT_ERROR_HPP
...
template<>
struct std::hash<::boost::handlebars::Error>
{
    std::size_t operator()(
        ::boost::handlebars::Error const& err) const noexcept
    {
...
template <>
struct std::formatter<boost::handlebars::Error> : std::formatter<std::string_view> {
  template <class FmtContext>
  auto format(boost::handlebars::Error const &err, FmtContext &ctx) const {
