...
#ifndef BOOST_HANDLEBARS_DOM_STRING_HPP
#define BOOST_HANDLEBARS_DOM_STRING_HPP
...
template <>
struct std::formatter<boost::handlebars::dom::String>
    : std::formatter<std::string_view> {
  template <class FmtContext>
  auto format(boost::handlebars::dom::String const &value, FmtContext &ctx) const {
