...
#ifndef BOOST_HANDLEBARS_DOM_VALUE_HPP
#define BOOST_HANDLEBARS_DOM_VALUE_HPP

#include <boost/handlebars/config.hpp>
#include <boost/handlebars/dom/array.hpp>
#include <boost/handlebars/dom/function.hpp>
#include <boost/handlebars/dom/kind.hpp>
#include <boost/handlebars/dom/object.hpp>
#include <boost/handlebars/dom/string.hpp>
    ...
    Value
{
    ...
    friend class Array;
    friend class Object;
    friend Value boost::handlebars::safeString(std::string_view str);
...
public:
    ...
    */
    ...
    {
        BOOST_HANDLEBARS_ASSERT(isBoolean());
        return b_ != 0;
    }
    ...
    */
    ...
    {
        BOOST_HANDLEBARS_ASSERT(isInteger());
        return i_;
    }
    ...
    */
    ...
    {
        BOOST_HANDLEBARS_ASSERT(isString() || isSafeString());
        return str_;
    }
...
#include <boost/handlebars/dom/array.ipp>
#include <boost/handlebars/dom/function.ipp>
#include <boost/handlebars/dom/object.ipp>

//------------------------------------------------

template <>
struct std::formatter<boost::handlebars::dom::Value>
    : public std::formatter<std::string> {
  template <class FmtContext>
  auto format(boost::handlebars::dom::Value const &value, FmtContext &ctx) const {
