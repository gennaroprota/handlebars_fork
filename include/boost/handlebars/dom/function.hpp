...
#ifndef BOOST_HANDLEBARS_DOM_FUNCTION_HPP
#define BOOST_HANDLEBARS_DOM_FUNCTION_HPP

#include <boost/handlebars/config.hpp>
#include <boost/handlebars/dom/kind.hpp>
#include <boost/handlebars/dom/string.hpp>
#include <boost/handlebars/support/expected.hpp>
#include <memory>
