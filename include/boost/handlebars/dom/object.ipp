...
#ifndef BOOST_HANDLEBARS_DOM_OBJECT_IPP
#define BOOST_HANDLEBARS_DOM_OBJECT_IPP
...
template<>
struct std::formatter<boost::handlebars::dom::Object>
    : std::formatter<std::string>
{
    template <class FmtContext>
    auto format(
        boost::handlebars::dom::Object const& value,
